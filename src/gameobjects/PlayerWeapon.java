	...
	public PlayerWeapon(WeaponType weaponType){
		...
		if(weaponType == WeaponType.PRIM){
			...
			projData = new ProjectileData(ProjectileData.ProjType.STRAIGHT,
											7, ProjectileData.DIR_UP, 30, Particle.ExplosionType.SMALL_GREEN, Particle.ExplosionDirection.DOWN,
											new HitboxCircle(2),
		...
		if(level < maxLevel){
			...
			if(weaponType == WeaponType.PRIM){
				switch(level){
					case 2:
						projData = new ProjectileData(ProjectileData.ProjType.STRAIGHT,
														9, ProjectileData.DIR_UP, 30, Particle.ExplosionType.GREEN, Particle.ExplosionDirection.DOWN,
														new HitboxCircle(3),
					...
					case 3:
						projData = new ProjectileData(ProjectileData.ProjType.STRAIGHT,
														12, ProjectileData.DIR_UP, 50, Particle.ExplosionType.RED, Particle.ExplosionDirection.DOWN,
														new HitboxCircle(3),
